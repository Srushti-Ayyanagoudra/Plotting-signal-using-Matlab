...
% Last Modified by GUIDE v2.5 13-Aug-2025 15:28:52
...
t=0:1/Fs:1;
f=10;
sawtooth_sig=sawtooth(2*pi*f*t,0.5);
axes(handles.axes3),plot(sawtooth_sig)
...
square_sig=square(2*pi*f*t);
sawtooth_sig=sawtooth(2*pi*f*t,0.5);
composite_sig=s+square_sig+sawtooth_sig;
